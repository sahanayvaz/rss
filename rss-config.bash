...
for policy_spec in "ls_c_v0"
do
     exp="RSS"
     
     exp_name="MARIO-1-1-$exp-NOISE-v0"
     ...
     python3 create_config.py --env_kind="mario" --env_id="SuperMarioBros-1-1-v0" \
                              ...
                              --layernormalize=0 --batchnormalize=0 \
                              --attention=0 --recurrent=0 \
                              --add_noise=1 --keep_noise=30 --noise_std=0.1 \
                              --save_interval=$save_interval --save_dir=$save_dir --log_dir="./log_dir" \
                              --exp_name=$exp_name --evaluation=0
done
...
do
     early_final=$((($level-1) * 6000000))
     exp_name="MARIO-1-1-RSS-NOISE-TR-$level-1-v0"
     python3 create_config.py --env_kind="mario" --env_id="SuperMarioBros-$level-1-v0" \
                              --NUM_ENVS=8 --NUM_LEVELS=0 \
                              --SET_SEED=0 --PAINT_VEL_INFO=0 --USE_DATA_AUGMENTATION=0 --GAME_TYPE="standard" \
                              --USE_BLACK_WHITE=0 --IS_HIGH_RES=0 --HIGH_DIFFICULTY=0 --nframeskip=4 \
                              ...
                              --add_noise=0 \
                              --save_interval=$save_interval --save_dir=$save_dir --log_dir="./log_dir" \
                              --load_dir="$save_dir/MARIO-1-1-RSS-NOISE-v0/" --transfer_load=1 --freeze_weights=1 \
                              --exp_name=$exp_name --evaluation=0
done
...
do
     early_final=$((($level-1) * 6000000))
     exp_name="MARIO-1-1-RSS-NOISE-TR-NOISE-$level-1-v0"
     python3 create_config.py --env_kind="mario" --env_id="SuperMarioBros-$level-1-v0" \
                              --NUM_ENVS=8 --NUM_LEVELS=0 \
                              --SET_SEED=0 --PAINT_VEL_INFO=0 --USE_DATA_AUGMENTATION=0 --GAME_TYPE="standard" \
                              --USE_BLACK_WHITE=0 --IS_HIGH_RES=0 --HIGH_DIFFICULTY=0 --nframeskip=4 \
...
early_final=6000000
exp_name="MARIO-1-1-RSS-SPARSE-v0"
python3 create_config.py --env_kind="mario" --env_id="SuperMarioBros-1-1-v0" \
                         --NUM_ENVS=8 --NUM_LEVELS=0 \
                         --SET_SEED=0 --PAINT_VEL_INFO=0 --USE_DATA_AUGMENTATION=0 --GAME_TYPE="standard" \
                         --USE_BLACK_WHITE=0 --IS_HIGH_RES=0 --HIGH_DIFFICULTY=0 --nframeskip=4 \
...
early_final=6000000
exp_name="MARIO-1-1-RSS-SPARSE-v1"
python3 create_config.py --env_kind="mario" --env_id="SuperMarioBros-1-1-v0" \
                         --NUM_ENVS=8 --NUM_LEVELS=0 \
                         --SET_SEED=0 --PAINT_VEL_INFO=0 --USE_DATA_AUGMENTATION=0 --GAME_TYPE="standard" \
                         --USE_BLACK_WHITE=0 --IS_HIGH_RES=0 --HIGH_DIFFICULTY=0 --nframeskip=4 \
...
early_final=6000000
exp_name="MARIO-1-1-RSS-SPARSE-v2"
python3 create_config.py --env_kind="mario" --env_id="SuperMarioBros-1-1-v0" \
                         --NUM_ENVS=8 --NUM_LEVELS=0 \
                         --SET_SEED=0 --PAINT_VEL_INFO=0 --USE_DATA_AUGMENTATION=0 --GAME_TYPE="standard" \
                         --USE_BLACK_WHITE=0 --IS_HIGH_RES=0 --HIGH_DIFFICULTY=0 --nframeskip=4 \
...
early_final=6000000
exp_name="MARIO-1-1-RSS-SPARSE-v3"
python3 create_config.py --env_kind="mario" --env_id="SuperMarioBros-1-1-v0" \
                         --NUM_ENVS=8 --NUM_LEVELS=0 \
                         --SET_SEED=0 --PAINT_VEL_INFO=0 --USE_DATA_AUGMENTATION=0 --GAME_TYPE="standard" \
                         --USE_BLACK_WHITE=0 --IS_HIGH_RES=0 --HIGH_DIFFICULTY=0 --nframeskip=4 \
...
early_final=6000000
exp_name="MARIO-1-1-RSS-SPARSE-v4"
python3 create_config.py --env_kind="mario" --env_id="SuperMarioBros-1-1-v0" \
                         --NUM_ENVS=8 --NUM_LEVELS=0 \
                         --SET_SEED=0 --PAINT_VEL_INFO=0 --USE_DATA_AUGMENTATION=0 --GAME_TYPE="standard" \
                         --USE_BLACK_WHITE=0 --IS_HIGH_RES=0 --HIGH_DIFFICULTY=0 --nframeskip=4 \
